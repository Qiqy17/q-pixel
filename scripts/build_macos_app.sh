...
VERSION="${QPIXEL_VERSION:-1.1.0}"
BUILD_NUMBER="${QPIXEL_BUILD_NUMBER:-2}"
...
for file in index.html styles.css app.js manifest.webmanifest icon.svg offline.html sw.js; do
